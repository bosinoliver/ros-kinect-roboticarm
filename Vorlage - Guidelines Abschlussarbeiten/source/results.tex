...
\begin{tabularx}{\textwidth}{X|}
 ...
 \lstinline[basicstyle=\ttfamily\color{black}]|$ mkdir -p ~/<name des Workspace>/src|\\
 \lstinline[basicstyle=\ttfamily\color{black}]|$ cd ~/<name des Workspace>/|\\
 \lstinline[basicstyle=\ttfamily\color{black}]|$ catkin_make|\\ \hline
		
\end{tabularx}
\\
\\
Nachdem der Catkin-Workspace erstellt und gebaut wurde, sollte die Ordnerstruktur wie in Abbildung \ref{fig:Ordnerstruktur Catkin-Workspace} dargestellt aussehen:

\begin{figure}
	\centering
		\includegraphics[width=0.85\textwidth]{images/results/CatkinWorkspace.png}
