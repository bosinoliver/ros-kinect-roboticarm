...
\lstinputlisting[language=C++, firstline=75, lastline=129, caption={Hauptschleife - gesture\_control.cpp}, label=lst:Hauptschleife]{images/results/gesture_control.cpp}
