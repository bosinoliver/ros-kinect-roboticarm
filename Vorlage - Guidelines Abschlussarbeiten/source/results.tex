...
\begin{figure}
	\centering
		\includegraphics[width=0.7\textwidth]{images/results/CatkinWorkspace.png}
...
\\
\\
Der Knoten, der die Daten des Skeletts in ROS veröffentlicht, wird in einem zweiten Terminal mit folgenden Befehl gestartet:\\
\\
\begin{tabularx}{\textwidth}{|X|}
\hline
