...
\begin{figure}
	...
	\caption[Architektur MoveIt!]{Architektur MoveIt! \footnotemark[3]}
	\label{fig:Architektur MoveIt!}
\end{figure}

\footnotetext[3]{(besucht am 03.06.2019): https://moveit.ros.org/documentation/concepts/ }
...
Die ''Planning Scene'' repräsentiert die Welt um den Roboter herum und beinhaltet auch den aktuellen Zustand von Roboter selbst. Die ''Planning Scene''-Schnittstelle bietet den primären Zugriff für Nutzer, um den Zustand der Welt, in der der Roboter operiert, zu verändern.

\subsubsection*{Trajectory Processing}
Im Gegensatz zu reinen Bewegungsplanern bietet ''MoveIt!'' zusätzlich ein ''Trajectory Processing''. Dies bedeutet das neben dem Weg auch die Beschleunigung, an bestimmten Punkten, berechnet wird. Somit kann der Weg zeitparametrisiert werden. Notwendige Limits für die Beschleunigung der einzelnen Gelenke, werden aus der Datei  ausgelesen.
