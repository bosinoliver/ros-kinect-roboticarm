...
Der ''Parameter Server'' stellt eine geteilte Bibliothek von Parametern dar, welche innerhalb des Masters ausgeführt wird. Knoten können zur Laufzeit Parameter in dieser Bibliothek speichern und abrufen.

\item Messages: 
Wenn ein Knoten Daten unter einem Topic veröffentlicht, dann geschieht dies als sogenannte ''Message''.
