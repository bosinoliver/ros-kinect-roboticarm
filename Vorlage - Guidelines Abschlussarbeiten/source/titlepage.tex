...
\begin{tabular}{ll}
		...
		% Dr. rer. nat. Stefan Herrmann Thomas Latzel & Weitere Betreuer kï¿½nnen entsprechend eingefï¿½gt werden
\end{tabular}
...
Neubiberg, Juni 2019 %% Hier den entsprechenden Monat und das Jahr vermerken
